...
<project version="4">
  ...
  <component name="ChangeListManager">
    <list default="true" id="00a1685d-475c-4da6-b8e3-24a36cd4825c" name="Default Changelist" comment="" />
  ...
  <component name="ExecutionTargetManager" SELECTED_TARGET="FWVGA_API_28" />
